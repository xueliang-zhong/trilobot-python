...
## Active algorithm (gen06)
- **5-angle scan**: -80, -45, 0, 45, 80 degrees
- **Scoring**: corridor support + isolation penalty + distance advantage + edge penalty + turn habit anti-repetition + target heading memory + EMA openness bias
